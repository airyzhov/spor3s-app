...
export const LEVEL_CONFIG = [
  ...
  },
  {
    ...
    discountPercent: 5,
    benefits: ['5% скидка на любой заказ', 'Бонусные товары для практик в магазине: травы, благовония, чай']
  },
  {
    level: 5,
    code: 'legend',
    ...
    ordersCountRequired: 0,
    discountPercent: 10,
    benefits: ['10% скидка на любой заказ', 'Доступ к авторскому курсу «Практики для развития внимания и снятия тревожности»']
  }
];
