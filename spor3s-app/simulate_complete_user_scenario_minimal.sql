-- Минимальный тест сценария пользователя
...
BEGIN
    ...
    -- 2. Создание заказа через AI чат (минимальные колонки)
    ...
    -- 3. Создание подписок (минимальные колонки)
    ...
    -- 7. Создание реферального пользователя
