...
const SHEET_LINKS = [
  { name: "Заказы", sheet: "orders_sync", gid: "0" },
  { name: "Пользователи", sheet: "users_sync", gid: "TODO_USERS_GID" },
  { name: "Транзакции", sheet: "coin_transactions_sync", gid: "TODO_COIN_GID" },
  { name: "Челленджи", sheet: "challenges_sync", gid: "TODO_CHALLENGE_GID" },
  { name: "Дневные чекины", sheet: "daily_checkins_sync", gid: "TODO_DAILY_GID" },
  { name: "Инструкции", sheet: "instructions_sync", gid: "TODO_INSTR_GID" },
  { name: "Сообщения", sheet: "messages_sync", gid: "TODO_MSG_GID" },
  { name: "Продукты", sheet: "products_sync", gid: "TODO_PROD_GID" },
  { name: "Саплименты", sheet: "supplement_checkins_sync", gid: "TODO_SUPPL_GID" },
  { name: "Опросы", sheet: "surveys_sync", gid: "TODO_SURVEY_GID" },
  { name: "Еженедельные отзывы", sheet: "weekly_reviews_sync", gid: "TODO_WEEKLY_GID" },
];
        ...
        <ul className="space-y-2">
          <li>
            <a href="https://docs.google.com/spreadsheets/d/1ZS8C0_mwUsWr1vgy_lLJ0XPDTmKYT5S9JMWQKfkvADU/edit#gid=0" target="_blank" rel="noopener noreferrer" className="text-green-700 underline font-bold hover:text-pink-600">
              Новые заказы за сегодня (фильтр по дате в orders_sync)
            </a>
          </li>
          <li>
            <a href="https://docs.google.com/spreadsheets/d/1ZS8C0_mwUsWr1vgy_lLJ0XPDTmKYT5S9JMWQKfkvADU/edit#gid=0" target="_blank" rel="noopener noreferrer" className="text-green-700 underline font-bold hover:text-pink-600">
              Новые заказы за неделю (фильтр по дате в orders_sync)
            </a>
          </li>
          <li>
            <a href="https://docs.google.com/spreadsheets/d/1ZS8C0_mwUsWr1vgy_lLJ0XPDTmKYT5S9JMWQKfkvADU/edit#gid=TODO_MSG_GID" target="_blank" rel="noopener noreferrer" className="text-purple-700 underline font-bold hover:text-pink-600">
              Активные чаты за день (messages_sync, фильтр по дате, группировка по user_id)
            </a>
          </li>
        </ul>
